...
export function LocationSearch({ value, onChange, excludeIds, initialLabel = "" }: LocationSearchProps) {
    ...
    return (
        <div className="relative">
            ...
            {open && available.length > 0 && (
                ...
                R{String(loc.row).padStart(3, "0")} C{String(loc.col).padStart(3, "0")} L{loc.level}
              </span>
                        </button>
                    ))}
                </div>
