...
export default function UsersPage() {
    ...
    const superuserCount = users.filter((u) => u.permissions.includes(PERMISSIONS.DELETE_USERS)).length;
        ...
        <div className="space-y-5" data-testid="users-page">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Manage accounts and clearances</p>
                </div>
                            ...
                            <TableBody>
                                {users.map((u) => (
                                    <TableRow key={u.id} data-testid={`row-user-${u.id}`}>
                                        ...
                                        <TableCell className="text-sm text-muted-foreground">{u.callsign || "—"}</TableCell>
                                        <TableCell>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete {deleteTarget?.full_name} (@{deleteTarget?.username})? This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
